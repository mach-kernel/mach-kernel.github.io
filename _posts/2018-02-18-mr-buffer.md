...
Let's combine everything we have so far, and add the softswitch toggling code to make a simple and imperative hello world program. 
...
We almost have all the pieces we need to make a small text editor, so we need to solve just one last problem. 
